...
public class AddressMapper extends CoreMapper {
	...
	{
		addFilter("addressFilter", filterOutAllExcept(Address_.COUNTRY, Address_.CITY, Address_.STREET, Address_.NUMBER_OF_HOUSE_OR_APARTMENT, Address_.ZIP_CODE, Address_.CUSTOMERS));
