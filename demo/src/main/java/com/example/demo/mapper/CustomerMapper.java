...
public class CustomerMapper extends CoreMapper {
	...
	{
		addFilter(Customer.class, filterOutAllExcept(Customer_.FIRST_NAME, Customer_.SURNAME, Customer_.PESEL, Customer_.ADDRESS, Customer_.ORDERS));
		addFilter(Address.class, filterOutAllExcept(Address_.COUNTRY, Address_.CITY, Address_.STREET, Address_.NUMBER_OF_HOUSE_OR_APARTMENT, Address_.ZIP_CODE));
