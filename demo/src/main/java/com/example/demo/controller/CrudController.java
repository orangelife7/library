...
public abstract class CrudController<T extends BaseEntity> {
	...
	/*
	 * @GetMapping("/list") public List<T> findAll() { return
	 * getService().findAll(); }
	 */
	...
	/*
	 * @GetMapping("/{id}") public T findById(@PathVariable Long id) { return
	 * getService().findById(id) .orElseThrow(() -> new
	 * EntityNotFoundException("Entity not found with id: " + id)); }
	 */
	...
	private Class<?> getEntityClass() {
		return (Class<?>) ((java.lang.reflect.ParameterizedType) getClass().getGenericSuperclass())
